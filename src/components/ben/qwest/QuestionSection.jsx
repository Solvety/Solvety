...
const Question = ({ question, fade }) => (
  <div className="bg-white p-3 md:p-5 md:text-xl rounded-xl text-slate-500 w-full md:w-[356px] text-center">
...
const Options = ({ answer, handleSelected, fade, option, index }) => {
  ...
  return (
    <div
      className={`md:text-xl rounded-[1.2rem] w-[131.72px] md:w-[179px] text-left ${
        answer ? "bg-[#8E5DF5] text-white" : "bg-white text-slate-500"
      } cursor-pointer py-2 md:py-3 px-1 flex items-center justify-center`}
